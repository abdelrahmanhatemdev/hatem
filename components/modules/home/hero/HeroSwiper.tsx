...
import HeroTextAnimate from "@/components/modules/home/hero/HeroTextAnimate";
import AvailableBadge from "@/components/modules/home/hero/AvailableBadge";
...
function HeroSwiper() {
  ...
  return (
    <section className="h-screen w-full relative">
      <AvailableBadge className= "absolute top-40 right-0 md:right-10"/>
